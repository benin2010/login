...
namespace login
{
    public partial class add_ppt : Form
    {
        data d = new data();
        ...
        private void ppt_add_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                string s = "insert into add_ppt (cls,sub_name,aca_yr,up_by,up_file) values('" + txtcls.Text + "','" + txtsn.Text + "','" + cmbacay.Text + "','" + txtupby.Text + "','" + btnupfile.Text + "')";
        ...
        public void load()
        {
            ...
            //      con.Open();
            con.Open();
            string s = "select * from add_ppt ORDER BY id DESC;";
            MySqlCommand cmd = new MySqlCommand(s, con);
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                MySqlConnection con = new MySqlConnection(d.getconnection());
                con.Open();
                string s = "update add_ppt set cls='" + txtcls.Text + "', sub_name='" + txtsn.Text + "', aca_yr='" + cmbacay.Text + "', up_by='" + txtupby.Text + "', up_file='" + btnupfile.Text + "' where id=" + index + "";
                MySqlCommand cmd = new MySqlCommand(s, con);
                cmd.ExecuteNonQuery();
                con.Close();
                clear();
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                MySqlConnection con = new MySqlConnection(d.getconnection());
                con.Open();
                string s = "delete from add_ppt where id=" + index + "";
                MySqlCommand cmd = new MySqlCommand(s, con);
                cmd.ExecuteNonQuery();
                con.Close();
                clear();
